...
const getValue = (obj: any, namePath: string | string[]) => {
...
function FormBuilderField(this: any, props: any) {
  ...
  const label = field.tooltip ? (
    <span>
      ...
      <Tooltip title={field.tooltip}>
        <QuestionCircleOutlined style={{ margin: '2px' }} />
      </Tooltip>
    </span>
  ) : (
    field.label
  ...
  const formItemProps = {
    ...
    ...(meta.formItemLayout !== null ? formItemLayout : {}), // labelCol,wrapperCol,className
    label,
    ...pick(field, [
      'help',
      'extra',
  ...
  if (isFieldViewMode) {
    ...
    let viewValue = has(formValues, field.key || field.name)
